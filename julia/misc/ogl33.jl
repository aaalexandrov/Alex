...
function updateGL()
	...
	for cNameStr in functionNames
		proc = wglGetProcAddress(cNameStr)
		if proc == C_NULL
			try
...
export CONSTANT_COLOR, ONE_MINUS_CONSTANT_COLOR, CONSTANT_ALPHA, ONE_MINUS_CONSTANT_ALPHA, BLEND_COLOR, FUNC_ADD, MIN, MAX, BLEND_EQUATION, FUNC_SUBTRACT, FUNC_REVERSE_SUBTRACT

@getGLFun glCullFace glCullFace(mode::GLenum)::Void

@getGLFun glFrontFace glFrontFace(mode::GLenum)::Void

@getGLFun glHint glHint(target::GLenum, mode::GLenum)::Void

@getGLFun glLineWidth glLineWidth(width::GLfloat)::Void

@getGLFun glPointSize glPointSize(size::GLfloat)::Void

@getGLFun glPolygonMode glPolygonMode(face::GLenum, mode::GLenum)::Void

@getGLFun glScissor glScissor(x::GLint, y::GLint, width::GLsizei, height::GLsizei)::Void

@getGLFun glTexParameterf glTexParameterf(target::GLenum, pname::GLenum, param::GLfloat)::Void

@getGLFun glTexParameterfv glTexParameterfv(target::GLenum, pname::GLenum, params::Ptr{GLfloat})::Void

@getGLFun glTexParameteri glTexParameteri(target::GLenum, pname::GLenum, param::GLint)::Void

@getGLFun glTexParameteriv glTexParameteriv(target::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glTexImage1D glTexImage1D(target::GLenum, level::GLint, internalformat::GLint, width::GLsizei, border::GLint, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glTexImage2D glTexImage2D(target::GLenum, level::GLint, internalformat::GLint, width::GLsizei, height::GLsizei, border::GLint, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glDrawBuffer glDrawBuffer(mode::GLenum)::Void

@getGLFun glClear glClear(mask::GLbitfield)::Void

@getGLFun glClearColor glClearColor(red::GLfloat, green::GLfloat, blue::GLfloat, alpha::GLfloat)::Void

@getGLFun glClearStencil glClearStencil(s::GLint)::Void

@getGLFun glClearDepth glClearDepth(depth::GLdouble)::Void

@getGLFun glStencilMask glStencilMask(mask::GLuint)::Void

@getGLFun glColorMask glColorMask(red::GLboolean, green::GLboolean, blue::GLboolean, alpha::GLboolean)::Void

@getGLFun glDepthMask glDepthMask(flag::GLboolean)::Void

@getGLFun glDisable glDisable(cap::GLenum)::Void

@getGLFun glEnable glEnable(cap::GLenum)::Void

@getGLFun glFinish glFinish()::Void

@getGLFun glFlush glFlush()::Void

@getGLFun glBlendFunc glBlendFunc(sfactor::GLenum, dfactor::GLenum)::Void

@getGLFun glLogicOp glLogicOp(opcode::GLenum)::Void

@getGLFun glStencilFunc glStencilFunc(func_::GLenum, ref::GLint, mask::GLuint)::Void

@getGLFun glStencilOp glStencilOp(fail::GLenum, zfail::GLenum, zpass::GLenum)::Void

@getGLFun glDepthFunc glDepthFunc(func_::GLenum)::Void

@getGLFun glPixelStoref glPixelStoref(pname::GLenum, param::GLfloat)::Void

@getGLFun glPixelStorei glPixelStorei(pname::GLenum, param::GLint)::Void

@getGLFun glReadBuffer glReadBuffer(mode::GLenum)::Void

@getGLFun glReadPixels glReadPixels(x::GLint, y::GLint, width::GLsizei, height::GLsizei, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glGetBooleanv glGetBooleanv(pname::GLenum, params::Ptr{GLboolean})::Void

@getGLFun glGetDoublev glGetDoublev(pname::GLenum, params::Ptr{GLdouble})::Void

@getGLFun glGetError glGetError()::Cint

@getGLFun glGetFloatv glGetFloatv(pname::GLenum, params::Ptr{GLfloat})::Void

@getGLFun glGetIntegerv glGetIntegerv(pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetString glGetString(name::GLenum)::Ptr{Cuchar}

@getGLFun glGetTexImage glGetTexImage(target::GLenum, level::GLint, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glGetTexParameterfv glGetTexParameterfv(target::GLenum, pname::GLenum, params::Ptr{GLfloat})::Void

@getGLFun glGetTexParameteriv glGetTexParameteriv(target::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetTexLevelParameterfv glGetTexLevelParameterfv(target::GLenum, level::GLint, pname::GLenum, params::Ptr{GLfloat})::Void

@getGLFun glGetTexLevelParameteriv glGetTexLevelParameteriv(target::GLenum, level::GLint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glIsEnabled glIsEnabled(cap::GLenum)::Bool

@getGLFun glDepthRange glDepthRange(near_::GLdouble, far_::GLdouble)::Void

@getGLFun glViewport glViewport(x::GLint, y::GLint, width::GLsizei, height::GLsizei)::Void

@getGLFun glDrawArrays glDrawArrays(mode::GLenum, first::GLint, count::GLsizei)::Void

@getGLFun glDrawElements glDrawElements(mode::GLenum, count::GLsizei, type_::GLenum, indices::Ptr{Void})::Void

@getGLFun glGetPointerv glGetPointerv(pname::GLenum, params::Ptr{Ptr{Void}})::Void

@getGLFun glPolygonOffset glPolygonOffset(factor::GLfloat, units::GLfloat)::Void

@getGLFun glCopyTexImage1D glCopyTexImage1D(target::GLenum, level::GLint, internalformat::GLenum, x::GLint, y::GLint, width::GLsizei, border::GLint)::Void

@getGLFun glCopyTexImage2D glCopyTexImage2D(target::GLenum, level::GLint, internalformat::GLenum, x::GLint, y::GLint, width::GLsizei, height::GLsizei, border::GLint)::Void

@getGLFun glCopyTexSubImage1D glCopyTexSubImage1D(target::GLenum, level::GLint, xoffset::GLint, x::GLint, y::GLint, width::GLsizei)::Void

@getGLFun glCopyTexSubImage2D glCopyTexSubImage2D(target::GLenum, level::GLint, xoffset::GLint, yoffset::GLint, x::GLint, y::GLint, width::GLsizei, height::GLsizei)::Void

@getGLFun glTexSubImage1D glTexSubImage1D(target::GLenum, level::GLint, xoffset::GLint, width::GLsizei, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glTexSubImage2D glTexSubImage2D(target::GLenum, level::GLint, xoffset::GLint, yoffset::GLint, width::GLsizei, height::GLsizei, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glBindTexture glBindTexture(target::GLenum, texture::GLuint)::Void

@getGLFun glDeleteTextures glDeleteTextures(n::GLsizei, textures::Ptr{GLuint})::Void

@getGLFun glGenTextures glGenTextures(n::GLsizei, textures::Ptr{GLuint})::Void

@getGLFun glIsTexture glIsTexture(texture::GLuint)::Bool

@getGLFun glIndexub glIndexub(c::GLubyte)::Void

@getGLFun glIndexubv glIndexubv(c::Ptr{GLubyte})::Void

@getGLFun glBlendColor glBlendColor(red::GLfloat, green::GLfloat, blue::GLfloat, alpha::GLfloat)::Void

@getGLFun glBlendEquation glBlendEquation(mode::GLenum)::Void

@getGLFun glDrawRangeElements glDrawRangeElements(mode::GLenum, start::GLuint, END::GLuint, count::GLsizei, type_::GLenum, indices::Ptr{Void})::Void

@getGLFun glTexImage3D glTexImage3D(target::GLenum, level::GLint, internalformat::GLint, width::GLsizei, height::GLsizei, depth::GLsizei, border::GLint, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glTexSubImage3D glTexSubImage3D(target::GLenum, level::GLint, xoffset::GLint, yoffset::GLint, zoffset::GLint, width::GLsizei, height::GLsizei, depth::GLsizei, format::GLenum, type_::GLenum, pixels::Ptr{Void})::Void

@getGLFun glCopyTexSubImage3D glCopyTexSubImage3D(target::GLenum, level::GLint, xoffset::GLint, yoffset::GLint, zoffset::GLint, x::GLint, y::GLint, width::GLsizei, height::GLsizei)::Void

@getGLFun glActiveTexture glActiveTexture(texture::GLenum)::Void

@getGLFun glSampleCoverage glSampleCoverage(value::GLfloat, invert::GLboolean)::Void

@getGLFun glCompressedTexImage3D glCompressedTexImage3D(target::GLenum, level::GLint, internalformat::GLenum, width::GLsizei, height::GLsizei, depth::GLsizei, border::GLint, imageSize::GLsizei, data::Ptr{Void})::Void

@getGLFun glCompressedTexImage2D glCompressedTexImage2D(target::GLenum, level::GLint, internalformat::GLenum, width::GLsizei, height::GLsizei, border::GLint, imageSize::GLsizei, data::Ptr{Void})::Void

@getGLFun glCompressedTexImage1D glCompressedTexImage1D(target::GLenum, level::GLint, internalformat::GLenum, width::GLsizei, border::GLint, imageSize::GLsizei, data::Ptr{Void})::Void

@getGLFun glCompressedTexSubImage3D glCompressedTexSubImage3D(target::GLenum, level::GLint, xoffset::GLint, yoffset::GLint, zoffset::GLint, width::GLsizei, height::GLsizei, depth::GLsizei, format::GLenum, imageSize::GLsizei, data::Ptr{Void})::Void

@getGLFun glCompressedTexSubImage2D glCompressedTexSubImage2D(target::GLenum, level::GLint, xoffset::GLint, yoffset::GLint, width::GLsizei, height::GLsizei, format::GLenum, imageSize::GLsizei, data::Ptr{Void})::Void

@getGLFun glCompressedTexSubImage1D glCompressedTexSubImage1D(target::GLenum, level::GLint, xoffset::GLint, width::GLsizei, format::GLenum, imageSize::GLsizei, data::Ptr{Void})::Void

@getGLFun glGetCompressedTexImage glGetCompressedTexImage(target::GLenum, level::GLint, img::Ptr{Void})::Void

@getGLFun glBlendFuncSeparate glBlendFuncSeparate(sfactorRGB::GLenum, dfactorRGB::GLenum, sfactorAlpha::GLenum, dfactorAlpha::GLenum)::Void

@getGLFun glMultiDrawArrays glMultiDrawArrays(mode::GLenum, first::Ptr{GLint}, count::Ptr{GLsizei}, drawcount::GLsizei)::Void

@getGLFun glMultiDrawElements glMultiDrawElements(mode::GLenum, count::Ptr{GLsizei}, type_::GLenum, indices::Ptr{Ptr{Void}}, drawcount::GLsizei)::Void

@getGLFun glPointParameterf glPointParameterf(pname::GLenum, param::GLfloat)::Void

@getGLFun glPointParameterfv glPointParameterfv(pname::GLenum, params::Ptr{GLfloat})::Void

@getGLFun glPointParameteri glPointParameteri(pname::GLenum, param::GLint)::Void

@getGLFun glPointParameteriv glPointParameteriv(pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGenQueries glGenQueries(n::GLsizei, ids::Ptr{GLuint})::Void

@getGLFun glDeleteQueries glDeleteQueries(n::GLsizei, ids::Ptr{GLuint})::Void

@getGLFun glIsQuery glIsQuery(id::GLuint)::Bool

@getGLFun glBeginQuery glBeginQuery(target::GLenum, id::GLuint)::Void

@getGLFun glEndQuery glEndQuery(target::GLenum)::Void

@getGLFun glGetQueryiv glGetQueryiv(target::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetQueryObjectiv glGetQueryObjectiv(id::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetQueryObjectuiv glGetQueryObjectuiv(id::GLuint, pname::GLenum, params::Ptr{GLuint})::Void

@getGLFun glBindBuffer glBindBuffer(target::GLenum, buffer::GLuint)::Void

@getGLFun glDeleteBuffers glDeleteBuffers(n::GLsizei, buffers::Ptr{GLuint})::Void

@getGLFun glGenBuffers glGenBuffers(n::GLsizei, buffers::Ptr{GLuint})::Void

@getGLFun glIsBuffer glIsBuffer(buffer::GLuint)::Bool

@getGLFun glBufferData glBufferData(target::GLenum, size::GLsizeiptr, data::Ptr{Void}, usage::GLenum)::Void

@getGLFun glBufferSubData glBufferSubData(target::GLenum, offset::GLintptr, size::GLsizeiptr, data::Ptr{Void})::Void

@getGLFun glGetBufferSubData glGetBufferSubData(target::GLenum, offset::GLintptr, size::GLsizeiptr, data::Ptr{Void})::Void

@getGLFun glMapBuffer glMapBuffer(target::GLenum, access::GLenum)::Ptr{Void}

@getGLFun glUnmapBuffer glUnmapBuffer(target::GLenum)::Bool

@getGLFun glGetBufferParameteriv glGetBufferParameteriv(target::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetBufferPointerv glGetBufferPointerv(target::GLenum, pname::GLenum, params::Ptr{Ptr{Void}})::Void

@getGLFun glBlendEquationSeparate glBlendEquationSeparate(modeRGB::GLenum, modeAlpha::GLenum)::Void

@getGLFun glDrawBuffers glDrawBuffers(n::GLsizei, bufs::Ptr{GLenum})::Void

@getGLFun glStencilOpSeparate glStencilOpSeparate(face::GLenum, sfail::GLenum, dpfail::GLenum, dppass::GLenum)::Void

@getGLFun glStencilFuncSeparate glStencilFuncSeparate(face::GLenum, func_::GLenum, ref::GLint, mask::GLuint)::Void

@getGLFun glStencilMaskSeparate glStencilMaskSeparate(face::GLenum, mask::GLuint)::Void

@getGLFun glAttachShader glAttachShader(program::GLuint, shader::GLuint)::Void

@getGLFun glBindAttribLocation glBindAttribLocation(program::GLuint, index::GLuint, name::Ptr{Cuchar})::Void

@getGLFun glCompileShader glCompileShader(shader::GLuint)::Void

@getGLFun glCreateProgram glCreateProgram()::Cuint

@getGLFun glCreateShader glCreateShader(type_::GLenum)::Cuint

@getGLFun glDeleteProgram glDeleteProgram(program::GLuint)::Void

@getGLFun glDeleteShader glDeleteShader(shader::GLuint)::Void

@getGLFun glDetachShader glDetachShader(program::GLuint, shader::GLuint)::Void

@getGLFun glDisableVertexAttribArray glDisableVertexAttribArray(index::GLuint)::Void

@getGLFun glEnableVertexAttribArray glEnableVertexAttribArray(index::GLuint)::Void

@getGLFun glGetActiveAttrib glGetActiveAttrib(program::GLuint, index::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, size::Ptr{GLint}, type_::Ptr{GLenum}, name::Ptr{Cuchar})::Void

@getGLFun glGetActiveUniform glGetActiveUniform(program::GLuint, index::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, size::Ptr{GLint}, type_::Ptr{GLenum}, name::Ptr{Cuchar})::Void

@getGLFun glGetAttachedShaders glGetAttachedShaders(program::GLuint, maxCount::GLsizei, count::Ptr{GLsizei}, obj::Ptr{GLuint})::Void

@getGLFun glGetAttribLocation glGetAttribLocation(program::GLuint, name::Ptr{Cuchar})::Cint

@getGLFun glGetProgramiv glGetProgramiv(program::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetProgramInfoLog glGetProgramInfoLog(program::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, infoLog::Ptr{Cuchar})::Void

@getGLFun glGetShaderiv glGetShaderiv(shader::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetShaderInfoLog glGetShaderInfoLog(shader::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, infoLog::Ptr{Cuchar})::Void

@getGLFun glGetShaderSource glGetShaderSource(shader::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, source::Ptr{Cuchar})::Void

@getGLFun glGetUniformLocation glGetUniformLocation(program::GLuint, name::Ptr{Cuchar})::Cint

@getGLFun glGetUniformfv glGetUniformfv(program::GLuint, location::GLint, params::Ptr{GLfloat})::Void

@getGLFun glGetUniformiv glGetUniformiv(program::GLuint, location::GLint, params::Ptr{GLint})::Void

@getGLFun glGetVertexAttribdv glGetVertexAttribdv(index::GLuint, pname::GLenum, params::Ptr{GLdouble})::Void

@getGLFun glGetVertexAttribfv glGetVertexAttribfv(index::GLuint, pname::GLenum, params::Ptr{GLfloat})::Void

@getGLFun glGetVertexAttribiv glGetVertexAttribiv(index::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetVertexAttribPointerv glGetVertexAttribPointerv(index::GLuint, pname::GLenum, pointer::Ptr{Ptr{Void}})::Void

@getGLFun glIsProgram glIsProgram(program::GLuint)::Bool

@getGLFun glIsShader glIsShader(shader::GLuint)::Bool

@getGLFun glLinkProgram glLinkProgram(program::GLuint)::Void

@getGLFun glShaderSource glShaderSource(shader::GLuint, count::GLsizei, string_::Ptr{Ptr{Cuchar}}, length::Ptr{GLint})::Void

@getGLFun glUseProgram glUseProgram(program::GLuint)::Void

@getGLFun glUniform1f glUniform1f(location::GLint, v0::GLfloat)::Void

@getGLFun glUniform2f glUniform2f(location::GLint, v0::GLfloat, v1::GLfloat)::Void

@getGLFun glUniform3f glUniform3f(location::GLint, v0::GLfloat, v1::GLfloat, v2::GLfloat)::Void

@getGLFun glUniform4f glUniform4f(location::GLint, v0::GLfloat, v1::GLfloat, v2::GLfloat, v3::GLfloat)::Void

@getGLFun glUniform1i glUniform1i(location::GLint, v0::GLint)::Void

@getGLFun glUniform2i glUniform2i(location::GLint, v0::GLint, v1::GLint)::Void

@getGLFun glUniform3i glUniform3i(location::GLint, v0::GLint, v1::GLint, v2::GLint)::Void

@getGLFun glUniform4i glUniform4i(location::GLint, v0::GLint, v1::GLint, v2::GLint, v3::GLint)::Void

@getGLFun glUniform1fv glUniform1fv(location::GLint, count::GLsizei, value::Ptr{GLfloat})::Void

@getGLFun glUniform2fv glUniform2fv(location::GLint, count::GLsizei, value::Ptr{GLfloat})::Void

@getGLFun glUniform3fv glUniform3fv(location::GLint, count::GLsizei, value::Ptr{GLfloat})::Void

@getGLFun glUniform4fv glUniform4fv(location::GLint, count::GLsizei, value::Ptr{GLfloat})::Void

@getGLFun glUniform1iv glUniform1iv(location::GLint, count::GLsizei, value::Ptr{GLint})::Void

@getGLFun glUniform2iv glUniform2iv(location::GLint, count::GLsizei, value::Ptr{GLint})::Void

@getGLFun glUniform3iv glUniform3iv(location::GLint, count::GLsizei, value::Ptr{GLint})::Void

@getGLFun glUniform4iv glUniform4iv(location::GLint, count::GLsizei, value::Ptr{GLint})::Void

@getGLFun glUniformMatrix2fv glUniformMatrix2fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glUniformMatrix3fv glUniformMatrix3fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glUniformMatrix4fv glUniformMatrix4fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glValidateProgram glValidateProgram(program::GLuint)::Void

@getGLFun glVertexAttribPointer glVertexAttribPointer(index::GLuint, size::GLint, type_::GLenum, normalized::GLboolean, stride::GLsizei, pointer::Ptr{Void})::Void

@getGLFun glUniformMatrix2x3fv glUniformMatrix2x3fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glUniformMatrix3x2fv glUniformMatrix3x2fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glUniformMatrix2x4fv glUniformMatrix2x4fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glUniformMatrix4x2fv glUniformMatrix4x2fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glUniformMatrix3x4fv glUniformMatrix3x4fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glUniformMatrix4x3fv glUniformMatrix4x3fv(location::GLint, count::GLsizei, transpose::GLboolean, value::Ptr{GLfloat})::Void

@getGLFun glColorMaski glColorMaski(index::GLuint, r::GLboolean, g::GLboolean, b::GLboolean, a::GLboolean)::Void

@getGLFun glGetBooleani_v glGetBooleani_v(target::GLenum, index::GLuint, data::Ptr{GLboolean})::Void

@getGLFun glGetIntegeri_v glGetIntegeri_v(target::GLenum, index::GLuint, data::Ptr{GLint})::Void

@getGLFun glEnablei glEnablei(target::GLenum, index::GLuint)::Void

@getGLFun glDisablei glDisablei(target::GLenum, index::GLuint)::Void

@getGLFun glIsEnabledi glIsEnabledi(target::GLenum, index::GLuint)::Bool

@getGLFun glBeginTransformFeedback glBeginTransformFeedback(primitiveMode::GLenum)::Void

@getGLFun glEndTransformFeedback glEndTransformFeedback()::Void

@getGLFun glBindBufferRange glBindBufferRange(target::GLenum, index::GLuint, buffer::GLuint, offset::GLintptr, size::GLsizeiptr)::Void

@getGLFun glBindBufferBase glBindBufferBase(target::GLenum, index::GLuint, buffer::GLuint)::Void

@getGLFun glTransformFeedbackVaryings glTransformFeedbackVaryings(program::GLuint, count::GLsizei, varyings::Ptr{Ptr{Cuchar}}, bufferMode::GLenum)::Void

@getGLFun glGetTransformFeedbackVarying glGetTransformFeedbackVarying(program::GLuint, index::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, size::Ptr{GLsizei}, type_::Ptr{GLenum}, name::Ptr{Cuchar})::Void

@getGLFun glClampColor glClampColor(target::GLenum, clamp::GLenum)::Void

@getGLFun glBeginConditionalRender glBeginConditionalRender(id::GLuint, mode::GLenum)::Void

@getGLFun glEndConditionalRender glEndConditionalRender()::Void

@getGLFun glVertexAttribIPointer glVertexAttribIPointer(index::GLuint, size::GLint, type_::GLenum, stride::GLsizei, pointer::Ptr{Void})::Void

@getGLFun glGetVertexAttribIiv glGetVertexAttribIiv(index::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetVertexAttribIuiv glGetVertexAttribIuiv(index::GLuint, pname::GLenum, params::Ptr{GLuint})::Void

@getGLFun glVertexAttribI1i glVertexAttribI1i(index::GLuint, x::GLint)::Void

@getGLFun glVertexAttribI2i glVertexAttribI2i(index::GLuint, x::GLint, y::GLint)::Void

@getGLFun glVertexAttribI3i glVertexAttribI3i(index::GLuint, x::GLint, y::GLint, z::GLint)::Void

@getGLFun glVertexAttribI4i glVertexAttribI4i(index::GLuint, x::GLint, y::GLint, z::GLint, w::GLint)::Void

@getGLFun glVertexAttribI1ui glVertexAttribI1ui(index::GLuint, x::GLuint)::Void

@getGLFun glVertexAttribI2ui glVertexAttribI2ui(index::GLuint, x::GLuint, y::GLuint)::Void

@getGLFun glVertexAttribI3ui glVertexAttribI3ui(index::GLuint, x::GLuint, y::GLuint, z::GLuint)::Void

@getGLFun glVertexAttribI4ui glVertexAttribI4ui(index::GLuint, x::GLuint, y::GLuint, z::GLuint, w::GLuint)::Void

@getGLFun glVertexAttribI1iv glVertexAttribI1iv(index::GLuint, v::Ptr{GLint})::Void

@getGLFun glVertexAttribI2iv glVertexAttribI2iv(index::GLuint, v::Ptr{GLint})::Void

@getGLFun glVertexAttribI3iv glVertexAttribI3iv(index::GLuint, v::Ptr{GLint})::Void

@getGLFun glVertexAttribI4iv glVertexAttribI4iv(index::GLuint, v::Ptr{GLint})::Void

@getGLFun glVertexAttribI1uiv glVertexAttribI1uiv(index::GLuint, v::Ptr{GLuint})::Void

@getGLFun glVertexAttribI2uiv glVertexAttribI2uiv(index::GLuint, v::Ptr{GLuint})::Void

@getGLFun glVertexAttribI3uiv glVertexAttribI3uiv(index::GLuint, v::Ptr{GLuint})::Void

@getGLFun glVertexAttribI4uiv glVertexAttribI4uiv(index::GLuint, v::Ptr{GLuint})::Void

@getGLFun glVertexAttribI4bv glVertexAttribI4bv(index::GLuint, v::Ptr{GLbyte})::Void

@getGLFun glVertexAttribI4sv glVertexAttribI4sv(index::GLuint, v::Ptr{GLshort})::Void

@getGLFun glVertexAttribI4ubv glVertexAttribI4ubv(index::GLuint, v::Ptr{GLubyte})::Void

@getGLFun glVertexAttribI4usv glVertexAttribI4usv(index::GLuint, v::Ptr{GLushort})::Void

@getGLFun glGetUniformuiv glGetUniformuiv(program::GLuint, location::GLint, params::Ptr{GLuint})::Void

@getGLFun glBindFragDataLocation glBindFragDataLocation(program::GLuint, color::GLuint, name::Ptr{Cuchar})::Void

@getGLFun glGetFragDataLocation glGetFragDataLocation(program::GLuint, name::Ptr{Cuchar})::Cint

@getGLFun glUniform1ui glUniform1ui(location::GLint, v0::GLuint)::Void

@getGLFun glUniform2ui glUniform2ui(location::GLint, v0::GLuint, v1::GLuint)::Void

@getGLFun glUniform3ui glUniform3ui(location::GLint, v0::GLuint, v1::GLuint, v2::GLuint)::Void

@getGLFun glUniform4ui glUniform4ui(location::GLint, v0::GLuint, v1::GLuint, v2::GLuint, v3::GLuint)::Void

@getGLFun glUniform1uiv glUniform1uiv(location::GLint, count::GLsizei, value::Ptr{GLuint})::Void

@getGLFun glUniform2uiv glUniform2uiv(location::GLint, count::GLsizei, value::Ptr{GLuint})::Void

@getGLFun glUniform3uiv glUniform3uiv(location::GLint, count::GLsizei, value::Ptr{GLuint})::Void

@getGLFun glUniform4uiv glUniform4uiv(location::GLint, count::GLsizei, value::Ptr{GLuint})::Void

@getGLFun glTexParameterIiv glTexParameterIiv(target::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glTexParameterIuiv glTexParameterIuiv(target::GLenum, pname::GLenum, params::Ptr{GLuint})::Void

@getGLFun glGetTexParameterIiv glGetTexParameterIiv(target::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetTexParameterIuiv glGetTexParameterIuiv(target::GLenum, pname::GLenum, params::Ptr{GLuint})::Void

@getGLFun glClearBufferiv glClearBufferiv(buffer::GLenum, drawbuffer::GLint, value::Ptr{GLint})::Void

@getGLFun glClearBufferuiv glClearBufferuiv(buffer::GLenum, drawbuffer::GLint, value::Ptr{GLuint})::Void

@getGLFun glClearBufferfv glClearBufferfv(buffer::GLenum, drawbuffer::GLint, value::Ptr{GLfloat})::Void

@getGLFun glClearBufferfi glClearBufferfi(buffer::GLenum, drawbuffer::GLint, depth::GLfloat, stencil::GLint)::Void

@getGLFun glGetStringi glGetStringi(name::GLenum, index::GLuint)::Ptr{Cuchar}

@getGLFun glIsRenderbuffer glIsRenderbuffer(renderbuffer::GLuint)::Bool

@getGLFun glBindRenderbuffer glBindRenderbuffer(target::GLenum, renderbuffer::GLuint)::Void

@getGLFun glDeleteRenderbuffers glDeleteRenderbuffers(n::GLsizei, renderbuffers::Ptr{GLuint})::Void

@getGLFun glGenRenderbuffers glGenRenderbuffers(n::GLsizei, renderbuffers::Ptr{GLuint})::Void

@getGLFun glRenderbufferStorage glRenderbufferStorage(target::GLenum, internalformat::GLenum, width::GLsizei, height::GLsizei)::Void

@getGLFun glGetRenderbufferParameteriv glGetRenderbufferParameteriv(target::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glIsFramebuffer glIsFramebuffer(framebuffer::GLuint)::Bool

@getGLFun glBindFramebuffer glBindFramebuffer(target::GLenum, framebuffer::GLuint)::Void

@getGLFun glDeleteFramebuffers glDeleteFramebuffers(n::GLsizei, framebuffers::Ptr{GLuint})::Void

@getGLFun glGenFramebuffers glGenFramebuffers(n::GLsizei, framebuffers::Ptr{GLuint})::Void

@getGLFun glCheckFramebufferStatus glCheckFramebufferStatus(target::GLenum)::Cint

@getGLFun glFramebufferTexture1D glFramebufferTexture1D(target::GLenum, attachment::GLenum, textarget::GLenum, texture::GLuint, level::GLint)::Void

@getGLFun glFramebufferTexture2D glFramebufferTexture2D(target::GLenum, attachment::GLenum, textarget::GLenum, texture::GLuint, level::GLint)::Void

@getGLFun glFramebufferTexture3D glFramebufferTexture3D(target::GLenum, attachment::GLenum, textarget::GLenum, texture::GLuint, level::GLint, zoffset::GLint)::Void

@getGLFun glFramebufferRenderbuffer glFramebufferRenderbuffer(target::GLenum, attachment::GLenum, renderbuffertarget::GLenum, renderbuffer::GLuint)::Void

@getGLFun glGetFramebufferAttachmentParameteriv glGetFramebufferAttachmentParameteriv(target::GLenum, attachment::GLenum, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGenerateMipmap glGenerateMipmap(target::GLenum)::Void

@getGLFun glBlitFramebuffer glBlitFramebuffer(srcX0::GLint, srcY0::GLint, srcX1::GLint, srcY1::GLint, dstX0::GLint, dstY0::GLint, dstX1::GLint, dstY1::GLint, mask::GLbitfield, filter::GLenum)::Void

@getGLFun glRenderbufferStorageMultisample glRenderbufferStorageMultisample(target::GLenum, samples::GLsizei, internalformat::GLenum, width::GLsizei, height::GLsizei)::Void

@getGLFun glFramebufferTextureLayer glFramebufferTextureLayer(target::GLenum, attachment::GLenum, texture::GLuint, level::GLint, layer::GLint)::Void

@getGLFun glMapBufferRange glMapBufferRange(target::GLenum, offset::GLintptr, length::GLsizeiptr, access::GLbitfield)::Ptr{Void}

@getGLFun glFlushMappedBufferRange glFlushMappedBufferRange(target::GLenum, offset::GLintptr, length::GLsizeiptr)::Void

@getGLFun glBindVertexArray glBindVertexArray(array::GLuint)::Void

@getGLFun glDeleteVertexArrays glDeleteVertexArrays(n::GLsizei, arrays::Ptr{GLuint})::Void

@getGLFun glGenVertexArrays glGenVertexArrays(n::GLsizei, arrays::Ptr{GLuint})::Void

@getGLFun glIsVertexArray glIsVertexArray(array::GLuint)::Bool

@getGLFun glDrawArraysInstanced glDrawArraysInstanced(mode::GLenum, first::GLint, count::GLsizei, instancecount::GLsizei)::Void

@getGLFun glDrawElementsInstanced glDrawElementsInstanced(mode::GLenum, count::GLsizei, type_::GLenum, indices::Ptr{Void}, instancecount::GLsizei)::Void

@getGLFun glTexBuffer glTexBuffer(target::GLenum, internalformat::GLenum, buffer::GLuint)::Void

@getGLFun glPrimitiveRestartIndex glPrimitiveRestartIndex(index::GLuint)::Void

@getGLFun glCopyBufferSubData glCopyBufferSubData(readTarget::GLenum, writeTarget::GLenum, readOffset::GLintptr, writeOffset::GLintptr, size::GLsizeiptr)::Void

@getGLFun glGetUniformIndices glGetUniformIndices(program::GLuint, uniformCount::GLsizei, uniformNames::Ptr{Ptr{Cuchar}}, uniformIndices::Ptr{GLuint})::Void

@getGLFun glGetActiveUniformsiv glGetActiveUniformsiv(program::GLuint, uniformCount::GLsizei, uniformIndices::Ptr{GLuint}, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetActiveUniformName glGetActiveUniformName(program::GLuint, uniformIndex::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, uniformName::Ptr{Cuchar})::Void

@getGLFun glGetUniformBlockIndex glGetUniformBlockIndex(program::GLuint, uniformBlockName::Ptr{Cuchar})::Cuint

@getGLFun glGetActiveUniformBlockiv glGetActiveUniformBlockiv(program::GLuint, uniformBlockIndex::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetActiveUniformBlockName glGetActiveUniformBlockName(program::GLuint, uniformBlockIndex::GLuint, bufSize::GLsizei, length::Ptr{GLsizei}, uniformBlockName::Ptr{Cuchar})::Void

@getGLFun glUniformBlockBinding glUniformBlockBinding(program::GLuint, uniformBlockIndex::GLuint, uniformBlockBinding::GLuint)::Void

@getGLFun glGetInteger64i_v glGetInteger64i_v(target::GLenum, index::GLuint, data::Ptr{GLint64})::Void

@getGLFun glGetBufferParameteri64v glGetBufferParameteri64v(target::GLenum, pname::GLenum, params::Ptr{GLint64})::Void

@getGLFun glFramebufferTexture glFramebufferTexture(target::GLenum, attachment::GLenum, texture::GLuint, level::GLint)::Void

@getGLFun glDrawElementsBaseVertex glDrawElementsBaseVertex(mode::GLenum, count::GLsizei, type_::GLenum, indices::Ptr{Void}, basevertex::GLint)::Void

@getGLFun glDrawRangeElementsBaseVertex glDrawRangeElementsBaseVertex(mode::GLenum, start::GLuint, END::GLuint, count::GLsizei, type_::GLenum, indices::Ptr{Void}, basevertex::GLint)::Void

@getGLFun glDrawElementsInstancedBaseVertex glDrawElementsInstancedBaseVertex(mode::GLenum, count::GLsizei, type_::GLenum, indices::Ptr{Void}, instancecount::GLsizei, basevertex::GLint)::Void

@getGLFun glMultiDrawElementsBaseVertex glMultiDrawElementsBaseVertex(mode::GLenum, count::Ptr{GLsizei}, type_::GLenum, indices::Ptr{Ptr{Void}}, drawcount::GLsizei, basevertex::Ptr{GLint})::Void

@getGLFun glProvokingVertex glProvokingVertex(mode::GLenum)::Void

@getGLFun glFenceSync glFenceSync(condition::GLenum, flags::GLbitfield)::Sync

@getGLFun glIsSync glIsSync(sync::GLsync)::Bool

@getGLFun glDeleteSync glDeleteSync(sync::GLsync)::Void

@getGLFun glClientWaitSync glClientWaitSync(sync::GLsync, flags::GLbitfield, timeout::GLuClonglong)::Cint

@getGLFun glWaitSync glWaitSync(sync::GLsync, flags::GLbitfield, timeout::GLuint64)::Void

@getGLFun glGetInteger64v glGetInteger64v(pname::GLenum, params::Ptr{GLint64})::Void

@getGLFun glGetSynciv glGetSynciv(sync::GLsync, pname::GLenum, bufSize::GLsizei, length::Ptr{GLsizei}, values::Ptr{GLint})::Void

@getGLFun glTexImage2DMultisample glTexImage2DMultisample(target::GLenum, samples::GLsizei, internalformat::GLint, width::GLsizei, height::GLsizei, fixedsamplelocations::GLboolean)::Void

@getGLFun glTexImage3DMultisample glTexImage3DMultisample(target::GLenum, samples::GLsizei, internalformat::GLint, width::GLsizei, height::GLsizei, depth::GLsizei, fixedsamplelocations::GLboolean)::Void

@getGLFun glGetMultisamplefv glGetMultisamplefv(pname::GLenum, index::GLuint, val::Ptr{GLfloat})::Void

@getGLFun glSampleMaski glSampleMaski(index::GLuint, mask::GLbitfield)::Void

@getGLFun glVertexAttribDivisor glVertexAttribDivisor(index::GLuint, divisor::GLuint)::Void

@getGLFun glBindFragDataLocationIndexed glBindFragDataLocationIndexed(program::GLuint, colorNumber::GLuint, index::GLuint, name::Ptr{Cuchar})::Void

@getGLFun glGetFragDataIndex glGetFragDataIndex(program::GLuint, name::Ptr{Cuchar})::Cint

@getGLFun glGenSamplers glGenSamplers(count::GLsizei, samplers::Ptr{GLuint})::Void

@getGLFun glDeleteSamplers glDeleteSamplers(count::GLsizei, samplers::Ptr{GLuint})::Void

@getGLFun glIsSampler glIsSampler(sampler::GLuint)::Bool

@getGLFun glBindSampler glBindSampler(unit::GLuint, sampler::GLuint)::Void

@getGLFun glSamplerParameteri glSamplerParameteri(sampler::GLuint, pname::GLenum, param::GLint)::Void

@getGLFun glSamplerParameteriv glSamplerParameteriv(sampler::GLuint, pname::GLenum, param::Ptr{GLint})::Void

@getGLFun glSamplerParameterf glSamplerParameterf(sampler::GLuint, pname::GLenum, param::GLfloat)::Void

@getGLFun glSamplerParameterfv glSamplerParameterfv(sampler::GLuint, pname::GLenum, param::Ptr{GLfloat})::Void

@getGLFun glSamplerParameterIiv glSamplerParameterIiv(sampler::GLuint, pname::GLenum, param::Ptr{GLint})::Void

@getGLFun glSamplerParameterIuiv glSamplerParameterIuiv(sampler::GLuint, pname::GLenum, param::Ptr{GLuint})::Void

@getGLFun glGetSamplerParameteriv glGetSamplerParameteriv(sampler::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetSamplerParameterIiv glGetSamplerParameterIiv(sampler::GLuint, pname::GLenum, params::Ptr{GLint})::Void

@getGLFun glGetSamplerParameterfv glGetSamplerParameterfv(sampler::GLuint, pname::GLenum, params::Ptr{GLfloat})::Void

@getGLFun glGetSamplerParameterIuiv glGetSamplerParameterIuiv(sampler::GLuint, pname::GLenum, params::Ptr{GLuint})::Void

@getGLFun glQueryCounter glQueryCounter(id::GLuint, target::GLenum)::Void

@getGLFun glGetQueryObjecti64v glGetQueryObjecti64v(id::GLuint, pname::GLenum, params::Ptr{GLint64})::Void

@getGLFun glGetQueryObjectui64v glGetQueryObjectui64v(id::GLuint, pname::GLenum, params::Ptr{GLuint64})::Void

@getGLFun glVertexP2ui glVertexP2ui(type_::GLenum, value::GLuint)::Void

@getGLFun glVertexP2uiv glVertexP2uiv(type_::GLenum, value::Ptr{GLuint})::Void

@getGLFun glVertexP3ui glVertexP3ui(type_::GLenum, value::GLuint)::Void

@getGLFun glVertexP3uiv glVertexP3uiv(type_::GLenum, value::Ptr{GLuint})::Void

@getGLFun glVertexP4ui glVertexP4ui(type_::GLenum, value::GLuint)::Void

@getGLFun glVertexP4uiv glVertexP4uiv(type_::GLenum, value::Ptr{GLuint})::Void

@getGLFun glTexCoordP1ui glTexCoordP1ui(type_::GLenum, coords::GLuint)::Void

@getGLFun glTexCoordP1uiv glTexCoordP1uiv(type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glTexCoordP2ui glTexCoordP2ui(type_::GLenum, coords::GLuint)::Void

@getGLFun glTexCoordP2uiv glTexCoordP2uiv(type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glTexCoordP3ui glTexCoordP3ui(type_::GLenum, coords::GLuint)::Void

@getGLFun glTexCoordP3uiv glTexCoordP3uiv(type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glTexCoordP4ui glTexCoordP4ui(type_::GLenum, coords::GLuint)::Void

@getGLFun glTexCoordP4uiv glTexCoordP4uiv(type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glMultiTexCoordP1ui glMultiTexCoordP1ui(texture::GLenum, type_::GLenum, coords::GLuint)::Void

@getGLFun glMultiTexCoordP1uiv glMultiTexCoordP1uiv(texture::GLenum, type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glMultiTexCoordP2ui glMultiTexCoordP2ui(texture::GLenum, type_::GLenum, coords::GLuint)::Void

@getGLFun glMultiTexCoordP2uiv glMultiTexCoordP2uiv(texture::GLenum, type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glMultiTexCoordP3ui glMultiTexCoordP3ui(texture::GLenum, type_::GLenum, coords::GLuint)::Void

@getGLFun glMultiTexCoordP3uiv glMultiTexCoordP3uiv(texture::GLenum, type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glMultiTexCoordP4ui glMultiTexCoordP4ui(texture::GLenum, type_::GLenum, coords::GLuint)::Void

@getGLFun glMultiTexCoordP4uiv glMultiTexCoordP4uiv(texture::GLenum, type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glNormalP3ui glNormalP3ui(type_::GLenum, coords::GLuint)::Void

@getGLFun glNormalP3uiv glNormalP3uiv(type_::GLenum, coords::Ptr{GLuint})::Void

@getGLFun glColorP3ui glColorP3ui(type_::GLenum, color::GLuint)::Void

@getGLFun glColorP3uiv glColorP3uiv(type_::GLenum, color::Ptr{GLuint})::Void

@getGLFun glColorP4ui glColorP4ui(type_::GLenum, color::GLuint)::Void

@getGLFun glColorP4uiv glColorP4uiv(type_::GLenum, color::Ptr{GLuint})::Void

@getGLFun glSecondaryColorP3ui glSecondaryColorP3ui(type_::GLenum, color::GLuint)::Void

@getGLFun glSecondaryColorP3uiv glSecondaryColorP3uiv(type_::GLenum, color::Ptr{GLuint})::Void

@getGLFun glVertexAttribP1ui glVertexAttribP1ui(index::GLuint, type_::GLenum, normalized::GLboolean, value::GLuint)::Void

@getGLFun glVertexAttribP1uiv glVertexAttribP1uiv(index::GLuint, type_::GLenum, normalized::GLboolean, value::Ptr{GLuint})::Void

@getGLFun glVertexAttribP2ui glVertexAttribP2ui(index::GLuint, type_::GLenum, normalized::GLboolean, value::GLuint)::Void

@getGLFun glVertexAttribP2uiv glVertexAttribP2uiv(index::GLuint, type_::GLenum, normalized::GLboolean, value::Ptr{GLuint})::Void

@getGLFun glVertexAttribP3ui glVertexAttribP3ui(index::GLuint, type_::GLenum, normalized::GLboolean, value::GLuint)::Void

@getGLFun glVertexAttribP3uiv glVertexAttribP3uiv(index::GLuint, type_::GLenum, normalized::GLboolean, value::Ptr{GLuint})::Void

@getGLFun glVertexAttribP4ui glVertexAttribP4ui(index::GLuint, type_::GLenum, normalized::GLboolean, value::GLuint)::Void

@getGLFun glVertexAttribP4uiv glVertexAttribP4uiv(index::GLuint, type_::GLenum, normalized::GLboolean, value::Ptr{GLuint})::Void
